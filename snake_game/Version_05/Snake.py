...
class SnakeBlock(Sprite):
    ...
    @classmethod
    def get_is_moving_rigth(cls) -> bool:
        """ Getter para la bandera _is_moving_rigth"""
        return cls._is_moving_rigth
    @classmethod
    def set_is_moving_rigth(cls, value: bool) -> None:
        """ Setter para la bandera _is_moving_rigth """
        cls._is_moving_rigth = value
