...
class Configurations:
    ...
    _sound_game_over_path = "../media/sound_game_over.wav"
    _music_background_path = "../media/music_background.mp3"
    _sound_volume = 0.4  # 40% volumen para efectos
    _music_volume = 0.3  # 30% volumen para música
    ...
    # Controles del segundo jugador (NUEVO)
    ...
    # Tamaño del segundo soldado (puede ser igual al primero)
    _soldier2_size = (140, 80)

    @classmethod
    def get_second_player_controls(cls) -> dict:
        """Devuelve los controles del segundo jugador"""
        return cls._second_player_controls

    @classmethod
    def get_soldier2_size(cls) -> tuple:
        """Devuelve el tamaño del segundo soldado"""
